...
import * as fromDeviceCommands from './device-commands.reducers';
...
export interface DeviceState {
    ...
    deviceCommands: fromDeviceCommands.DeviceCommandsState;
}
...
export const reducers: ActionReducerMap<DeviceState> = {
    ...
    deviceCommands: fromDeviceCommands.deviceCommandsReducer
};
